...
from sora2wm.iopaint.schema import Device, RemoveBGModel, RunPluginRequest
...
class RemoveBG(BasePlugin):
    ...
    def _init_session(self, model_name: str):
        ...
        if model_name == RemoveBGModel.briaai_rmbg_1_4:
            from sora2wm.iopaint.plugins.briarmbg import (
                briarmbg_process,
            ...
            from sora2wm.iopaint.plugins.briarmbg2 import (
                briarmbg2_process,
