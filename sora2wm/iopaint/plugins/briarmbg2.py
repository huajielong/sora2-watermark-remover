...
_class_labels_TR_sorted = (
    ...
    "UAV, Umbrella, UnevenBars, UtilityPole, VacuumRemover, Violin, Wakesurfing, Watch, WaterTower, WateringPot, Well, WellLid, Wheel, Wheelchair, WindTurbine, Windmill, WineGlass, WireWhisk, Yacht"
)
