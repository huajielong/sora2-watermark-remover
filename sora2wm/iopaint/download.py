...
from sora2wm.iopaint.model.original_sd_configs import get_config_files
from sora2wm.iopaint.schema import ModelInfo, ModelType


def cli_download_model(model: str):
    from sora2wm.iopaint.model import models
    from sora2wm.iopaint.model.utils import handle_from_pretrained_exceptions
